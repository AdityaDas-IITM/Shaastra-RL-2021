...
class QNetwork(nn.Module):
    def __init__(self, action_size, input_shape, input_channels):
        ...
        self.conv2 = nn.Sequential(nn.Conv2d(8, 16, kernel_size = 5, stride = 2), nn.BatchNorm2d(16), nn.ReLU())
        ...
        self.conv5 = nn.Sequential(nn.Conv2d(64, 128, kernel_size = 3, stride = 1), nn.BatchNorm2d(128), nn.ReLU())
