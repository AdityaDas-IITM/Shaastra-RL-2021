...
class BirdPlayer(pygame.sprite.Sprite):
    ...
    def __init__(self,
                 ...
                 image_assets, rng, color="blue", scale=1.0):
...
class Pipe(pygame.sprite.Sprite):
    ...
    def __init__(self,
        ...
        self.width = self.image_assets["red"]["lower"].get_width()
        pygame.sprite.Sprite.__init__(self)
